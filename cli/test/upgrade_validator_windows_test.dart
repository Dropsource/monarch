...
void main() {
  ...
  group('validates monarch executable path', () {
    test('bin placed at root', () {
      {
        var errors = _validate(r'C:\bin\monarch.exe');
        expect(errors, [
      ...
      {
        var errors = _validate(r'bin\monarch.exe');
        expect(errors, [
    ...
    test('bin placed at user directory', () {
      {
        var errors = _validate(r'C:\Users\joe\bin\monarch.exe');
        expect(errors, [
          r'Expected to find path monarch\bin\monarch.exe, instead found joe\bin\monarch.exe'
        ]);
      }
      {
        var errors = _validate(r'C:\Program Files\bin\monarch.exe');
        expect(errors, [
    ...
    test('edge cases', () {
      {
        var errors = _validate(r'C:\monarch.exe');
        expect(errors, [
    ...
    test('monarch path ok', () {
      ...
      {
        var errors = _validate(r'C:\Users\joe\foo\monarch\bin\monarch.exe');
        expect(errors, isEmpty);
      }
    });
