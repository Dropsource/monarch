/// The annotation `@StorybookTheme` marks a variable as a theme that Dropsource Storybook
/// should use. The variable should be of type `ThemeData` and it should be a top-level
