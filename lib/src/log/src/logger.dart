...
Stream<LogEntry> get logEntryStream => _controller.stream;
...
class Logger {
  ...
  LogLevel get level {
    return _level ?? _defaultLogLevel;
  }
  ...
  void log(LogLevel logLevel, message, [Object error, StackTrace stackTrace]) {
    if (isLoggable(logLevel)) {
      ...
      if (error != null || stackTrace != null) {
        _controller.add(LogEntry.withError(
            logLevel, msg, name, error.toString(), stackTrace.toString()));
      } else {
        _controller.add(LogEntry.standard(logLevel, msg, name));
      }
    }
  }
