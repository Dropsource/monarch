...
class MetaLocalizationDefinition {
  ...
  MetaLocalizationDefinition({required this.localeLanguageTags, required this.delegateClassName});
}

class MetaLocalizationDefinitionMapper implements StandardMapper<MetaLocalizationDefinition> {
  @override
  MetaLocalizationDefinition fromStandardMap(Map<String, dynamic> args) => MetaLocalizationDefinition(
