...
const UserSelectionData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'showPerformanceOverlayEnabled', '3': 14, '4': 1, '5': 8, '10': 'showPerformanceOverlayEnabled'},
  ],
};

/// Descriptor for `UserSelectionData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userSelectionDataDescriptor = $convert.base64Decode('');
